...
public class view_attendance_student extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t4=findViewById(R.id.textView54);
        s1=findViewById(R.id.spinner8);
        b1=findViewById(R.id.button5);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        try {
            type=getIntent().getStringExtra("a");
        }
        catch (Exception e)
        {}
        ...
        ArrayAdapter<String> ad=new ArrayAdapter<>(view_attendance_student.this,android.R.layout.simple_list_item_1,month);
        s1.setAdapter(ad);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(view_attendance_student.this);
